...
public sealed class BinderVisitor : FullPolyBaseVisitor<Func<Context, IBinding>>
{
    private static readonly TermVisitor TermVisitor = new();
    private static readonly TypeVisitor TypeVisitor = new();

    public override Func<Context, IBinding> VisitBinder_term(FullPolyParser.Binder_termContext context)
    {
    ...
    public override Func<Context, IBinding> VisitBinder_type(FullPolyParser.Binder_typeContext context)
    {
