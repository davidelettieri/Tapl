...
{
    private static readonly IDeBruijnTermAdapter<ITerm, Var> Adapter = new FullPolySubstitutionAdapter();
    ...
    private sealed class FullPolySubstitutionAdapter : IDeBruijnTermAdapter<ITerm, Var>
    {
