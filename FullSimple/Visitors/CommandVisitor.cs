...
public sealed class CommandVisitor : FullSimpleBaseVisitor<Func<Context, (ICommand, Context)>>
{
    ...
    public override Func<Context, (ICommand, Context)> VisitCommand_binder(
        FullSimpleParser.Command_binderContext context)
    {
    ...
    public override Func<Context, (ICommand, Context)> VisitCommand_term(
        FullSimpleParser.Command_termContext context)
    {
        var info = context.GetFileInfo();
    ...
    public override Func<Context, (ICommand, Context)> VisitCommand_tybinder(
        FullSimpleParser.Command_tybinderContext context)
    {
        var info = context.GetFileInfo();
