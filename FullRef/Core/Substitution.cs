...
using static FullRef.Core.Shifting;

namespace FullRef.Core;

public static class Substitution
{
    private static readonly IDeBruijnTermAdapter<ITerm, Var> Adapter = new FullRefSubstitutionAdapter();
    ...
    private sealed class FullRefSubstitutionAdapter : IDeBruijnTermAdapter<ITerm, Var>
    {
